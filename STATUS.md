...
- **Verified A2A premise:** the live VouchSpec card and independent Agent Tools JSON listing agree
  on `https://vouchspec.plyrium.com/api/vouchspec/v1/a2a`; the independently replayed receipt
  SHA-256 is `3dc4efbe492dbad82a839a83eecadc2c4580661e96659f65664cb5ad83621e1d`.
