...
- **Commerce:** the first product is a USD $49 exact-version public static validation. Its
  ...
  signed delivery completed in a fake-provider sandbox. The proof is explicitly nonsettling
  and excluded. Public checkout remains disabled pending the authenticated API, real Stripe
  adapter, production signing role, and owner-controlled payment account.
