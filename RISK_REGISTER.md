...
| R-013 | Windows tests are generalized to Linux/cross-OS/archive safety. | Critical for Stage B | Linux container proof, adversarial tree/archive/path matrix, deterministic checks, explicit skip. | 102 pass; 1 Windows symlink-privilege skip |
