...
- Keep dependencies minimal and pinned. Prefer deterministic parsers and a precisely named
  deterministic JSON profile; do not imply RFC 8785 JCS unless it is actually implemented.
