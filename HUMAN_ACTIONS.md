...
The bounded worker, order system, and authenticated tenant/order/result boundary are ready in
a nonsettling loopback sandbox. The first unavoidable owner gate will be requested only after
the real Stripe adapter, paid-receipt lifecycle, and managed deployment configuration are also
ready: authenticate or create the chosen live payment-provider account and provide
